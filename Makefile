...
distdir: FORCE
	...
	$(COPY_FILE) --parents main.cpp srcs/AModule.class.cpp srcs/Cpu.class.cpp srcs/Date.class.cpp srcs/GKrellM.class.cpp srcs/Hostname.class.cpp srcs/Osinfo.class.cpp $(DISTDIR)/
